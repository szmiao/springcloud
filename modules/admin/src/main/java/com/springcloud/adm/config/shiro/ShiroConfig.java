...
import com.springcloud.adm.config.oauth2.OAuth2Filter;
import com.springcloud.adm.config.oauth2.Oauth2Realm;
...
public class ShiroConfig {
     ...
     */
    @Bean
    public SecurityManager securityManager(Oauth2Realm shiroRealm, SessionManager sessionManager) {
