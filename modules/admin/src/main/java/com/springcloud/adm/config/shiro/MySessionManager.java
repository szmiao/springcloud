 ...
 */
@Slf4j
public class MySessionManager extends DefaultSessionManager implements WebSessionManager {
    private Cookie sessionIdCookie;
    private boolean sessionIdCookieEnabled;

    public static final String COOKIE_NAME = ShiroHttpSession.DEFAULT_SESSION_ID_NAME + "_ADMIN";
    ...
    private Serializable getReferencedSessionId(ServletRequest request, ServletResponse response) {
        ...
        if (id != null) {
            ...
            id = getUriPathSegmentParamValue(request, COOKIE_NAME);
